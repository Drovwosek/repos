...
const string STRING_SPHERE = "Body type is sphere. Massa is 3392.92. Volume is 113.097. Density is 30. Radius is 3.";
...
const string STRING_PARALLELEPIPED = "Body type is parallelepiped. Massa is 1800. Volume is 60. Density is 30. Height is 3. Width is 4. Depth is 5.";
...
const string STRING_CYLINDER = "Body type is cylinder. Massa is 8482.3. Volume is 282.743. Density is 30. Base radius is 3. Height is 10.";
...
const string STRING_CONE = "Body type is cone. Massa is 2827.43. Volume is 94.248. Density is 30. Base radius is 3. Height is 10.";
...
TEST_CASE("Check compound body")
{
	...
	REQUIRE(comp.AddChildBody(make_shared<CParallelepiped>(DENSITY_PARALLELEPIPED, HEIGHT_PARALLELEPIPED, WIDTH_PARALLELEPIPED, DEPTH_PARALLELEPIPED)));
	REQUIRE(comp.AddChildBody(make_shared<CSphere>(DENSITY_SPHERE, RADIUS_SPHERE)));
...
TEST_CASE("recursive")
{
	shared_ptr<CCompound> a = make_shared<CCompound>();
	shared_ptr<CCompound> b = make_shared<CCompound>();
	shared_ptr<CCompound> c = make_shared<CCompound>();
	shared_ptr<CCone> cone = make_shared<CCone>(DENSITY_CONE, RADIUS_CONE, HEIGHT_CONE);
