...
bool CCarController::EngineOn(std::istream& args)
{
	if (m_car.IsTurnedOn())
	{
		m_output << "The car engine is already on" << std::endl;
		return true;
	}
	else
	{
		...
		{
			m_output << "Car engine started successfully" << std::endl;
			return true;
		}
		else
		{
			m_output << "Unable to start engine" << std::endl;
			return true;
		}
	}
...
bool CCarController::EngineOff(std::istream& args)
{
	if (!m_car.IsTurnedOn())
	{
		m_output << "The car engine is already off" << std::endl;
		return true;
	}
	else
	{
		...
		{
			m_output << "Car engine turned off successfully" << std::endl;
			return true;
		}
		else
		{
			m_output << "Unable to turn off engine" << std::endl;
			return true;
		}
	}
};
...
bool CCarController::SetGear(std::istream& args)
{
	...
	if (ConvertStringToint(arg, gear))
	{
		...
		{
			m_output << "You have successfully set gear" << std::endl;
		}
		else
		{
			m_output << "Unable to set gear" << std::endl;
		}
	}
...
bool CCarController::SetSpeed(std::istream& args)
{
	...
	if (ConvertStringToint(arg, speed))
	{
		...
		{
			m_output << "You have successfully set speed" << std::endl;
		}
		else
		{
			m_output << "Unable to set speed" << std::endl;
		}
	}
